			...
			<div class="card user-card">
				...
				<div class="card-body  text-center">
					<div class="usre-image">
						<img src="{{ asset('public/admin/assets/images/widget/img-round1.jpg') }}" class="img-radius wid-100 m-auto" alt="User-Profile-Image">
					</div>
...
@section('custom_js')
	<!-- dashboard-custom js -->
	<script src="{{ asset('public/admin/assets/js/pages/dashboard-analytics.js') }}"></script>
@endsection